...
const PRODUCTS = [
  {
    ...
    "audioGuide": [
      {
        "name": "톨레도 대성당",
        "url": "/audio/madrid-toledo-sample.mp3",
        "lat": 39.8578,
        "lng": -4.0273,
        "yt": "odJZqZPfMcg"
      },
      {
        "name": "산토토메",
        "url": "/audio/toledo-santotome.mp3",
        "lat": 39.8567,
        "lng": -4.0298,
        "yt": ""
      },
      {
        "name": "톨레도 대성당 정식판 1부 — 800년의 시간",
        "url": "/audio/toledo-cathedral-full-1.mp3",
        "lat": 39.8578,
        "lng": -4.0273,
        "yt": "odJZqZPfMcg"
      },
      {
        "name": "톨레도 대성당 정식판 2부 — 트란스파렌테의 기적",
        "url": "/audio/toledo-cathedral-full-2.mp3",
        "lat": 39.8578,
        "lng": -4.0273,
        "yt": "odJZqZPfMcg"
      }
    ...
    "detail": {
      ...
      "highlights": [
        "09:00 마드리드 출발 · 17:00 마드리드 도착(예정)",
        "톨레도 대성당 관람",
        "산토토메 (엘 그레코 명작)",
        "톨레도 구시가지 골목 자유시간",
        "최소 인원 미달 시 예약금 100% 환불"
      ],
      "includes": [
        "전용 차량",
        "유류비",
  ...
  },
  {
    ...
    "audioGuide": [
      {
        "name": "1부 — 그림 속의 그림, 시녀들",
        "url": "/audio/prado-1-meninas.mp3",
        "bg": "/audio/bg-prado-piano.mp3",
        "lat": 40.4138,
        "lng": -3.6921,
        "yt": "3tUN9rq2MyU"
      },
      {
        "name": "2부 — 전쟁의 참혹함, 1808년 5월 3일",
        "url": "/audio/prado-2-tresmayo.mp3",
        "bg": "/audio/bg-prado-piano.mp3",
        "lat": 40.4138,
        "lng": -3.6921,
        "yt": "JfLrdnL1pHM"
      ...
      {
        "name": "3부 — 고야의 어두운 걸작, 아들을 삼키는 사투르누스",
        "url": "/audio/prado-3-saturno.mp3",
        "bg": "/audio/bg-prado-piano.mp3",
        "lat": 40.4138,
        "lng": -3.6921,
        "yt": "xD7dXIzPVrc"
      ...
      {
        "name": "4부 — 상상력의 끝판왕, 세속적 쾌락의 동산",
        "url": "/audio/prado-4-jardin.mp3",
        "bg": "/audio/bg-prado-piano.mp3",
        "lat": 40.4138,
        "lng": -3.6921,
        "yt": "-CHyk7gAli8"
      ...
      {
        "name": "5부 — 스페인 최대의 미술 스캔들, 마하 두 점",
        "url": "/audio/prado-5-maja.mp3",
        "bg": "/audio/bg-prado-piano.mp3",
        "lat": 40.4138,
        "lng": -3.6921,
        "yt": "8CmyGenw7tQ"
      ...
      {
        "name": "6부 — 엘 그레코, 가슴에 손을 얹은 기사",
        "url": "/audio/prado-6-caballero.mp3",
        "bg": "/audio/bg-prado-piano.mp3",
        "lat": 40.4138,
        "lng": -3.6921,
        "yt": "7cKbY4_mQXk"
      ...
      {
        "name": "7부 — 눈물의 명작, 십자가에서 내려지는 그리스도",
        "url": "/audio/prado-7-descendimiento.mp3",
        "bg": "/audio/bg-prado-piano.mp3",
        "lat": 40.4138,
        "lng": -3.6921,
        "yt": "KdQRjgvqxwg"
      ...
      {
        "name": "8부 — 왕실을 향한 우아한 조롱, 카를로스 4세의 가족",
        "url": "/audio/prado-8-familia.mp3",
        "bg": "/audio/bg-prado-piano.mp3",
        "lat": 40.4138,
        "lng": -3.6921,
        "yt": "eC3-4vrZP_k"
      ...
      {
        "name": "9부 — 독일 르네상스의 자존심, 아담과 이브",
        "url": "/audio/prado-9-adaneva.mp3",
        "bg": "/audio/bg-prado-piano.mp3",
        "lat": 40.4138,
        "lng": -3.6921,
        "yt": ""
  ...
  },
  {
    ...
    "detail": {
      ...
      "highlights": [
        "리스본 2박 + 포르투 3박, 완전일주 5박 6일",
        "전 일정 4성급 호텔 · 전용차량 · 전문 가이드 동행",
        "신트라 페나 궁전 · 호카곶 · 카스카이스 경유",
        "포르투 야경투어 (동 루이스 다리 · 하베이라 항구)"
      ],
      "includes": [
        "전 일정 숙박 (4성급 호텔)",
        "전용차량 및 전용 가이드",
  ...
  },
  {
    ...
    "audioGuide": [
      {
        "name": "사그라다 파밀리아 1부 — 144년의 역사",
        "url": "/audio/sagrada-familia-1.mp3",
        "bg": "/audio/bg-sagrada-organ-choir.mp3",
        "bgVolume": 0.1,
        "lat": 41.4036,
        "lng": 2.1744,
        "yt": "VCM3tho_PFQ"
      ...
      {
        "name": "사그라다 파밀리아 2부 — 세 개의 파사드",
        "url": "/audio/sagrada-familia-2.mp3",
        "bg": "/audio/bg-sagrada-organ-choir.mp3",
        "bgVolume": 0.1,
        "lat": 41.4036,
        "lng": 2.1744,
      ...
      {
        "name": "구엘 공원 1부 — 동화 속 공원의 탄생",
        "url": "/audio/park-guell-1.mp3",
        "lat": 41.4145,
        "lng": 2.1527,
        "yt": "Rk9UM6Dv-0w"
      },
      {
        "name": "구엘 공원 2부 — 숨겨진 정수 시스템과 벤치",
        "url": "/audio/park-guell-2.mp3",
        "lat": 41.4145,
        "lng": 2.1527,
        "yt": ""
      },
      {
        "name": "알함브라 궁전 1부 — 붉은 성의 흥망성쇠",
        "url": "/audio/alhambra-1.mp3",
        "bg": "/audio/bg-guitar-alhambra.mp3",
        "lat": 37.176,
        "lng": -3.5986,
        "yt": "5dwYDPhM_qg"
      },
      {
        "name": "알함브라 궁전 2부 — 나스르 궁전",
        "url": "/audio/alhambra-2.mp3",
        "bg": "/audio/bg-guitar-alhambra.mp3",
        "lat": 37.176,
        "lng": -3.5986,
        "yt": "Ht15kRbXFsk"
      ...
      {
        "name": "알함브라 궁전 3부 — 헤네랄리페 정원",
        "url": "/audio/alhambra-3.mp3",
        "bg": "/audio/bg-guitar-alhambra.mp3",
        "lat": 37.176,
        "lng": -3.5986,
        "yt": "tz1STsTltVc"
      ...
      {
        "name": "세비야 대성당 1부 — 세계에서 가장 큰 고딕 성당",
        "url": "/audio/seville-cathedral-1.mp3",
        "lat": 37.386,
        "lng": -5.9926,
        "yt": ""
      },
      {
        "name": "세비야 대성당 2부 — 콜럼버스의 무덤과 히랄다 탑",
        "url": "/audio/seville-cathedral-2.mp3",
        "lat": 37.386,
        "lng": -5.9926,
        "yt": ""
      },
      {
        "name": "마드리드 왕궁 1부 — (왕궁의역사&내부 1)",
        "url": "/audio/madrid-palace-1.mp3",
        "lat": 40.418,
        "lng": -3.7143,
        "yt": ""
      },
      {
        "name": "마드리드 왕궁 2부 — (왕궁의화려함)",
        "url": "/audio/madrid-palace-2.mp3",
        "lat": 40.418,
        "lng": -3.7143,
        "yt": ""
      }
  ...
  },
  {
    ...
    "detail": {
      ...
      "highlights": [
        "투이 → 오 포리뇨 → 레돈델라 → 폰테베드라 → 칼다스 데 레이스 → 파드론 → 산티아고 데 콤포스텔라",
        "하루 평균 20km 내외, 6일간 총 약 119km 도보",
        "아름다운 해안길과 중세 마을 탐방",
        "현지 특식 & 와인으로 즐거운 여정",
        "전문 인솔자 전 일정 동행"
      ],
  ...
  },
  {
    ...
    "detail": {
      ...
      "highlights": [
        "09:00 마드리드 아토차역 출발 · 18:00 그라나다역 도착(예정)",
        "푸에르토 라피세(돈키호테 마을) 약 2시간 자유관광",
        "전 일정 한국인 기사 동행 (25인승 이상은 인솔자 동행)",
        "인원별 9인승 밴 · 25인승 스프린터 · 45인승 버스 배정"
      ],
      "includes": [
        "차량",
        "기사",
  ...
  },
  {
    ...
    "detail": {
      ...
      "highlights": [
        "07:30 그라나다 출발 · 18:00 마드리드 도착(예정)",
        "꼬르도바 메스키타 대성당 관람 (유네스코 세계문화유산)",
        "로마 다리 · 유대인 지구(꽃의 길) 자유시간",
        "한국인 기사 전 일정 동행",
        "인원별 프라이빗 밴 · 스프린터 · 전용 버스 배정"
      ],
      "includes": [
        "전용 차량",
        "유류비",
  ...
  },
  {
    ...
    "detail": {
      ...
      "highlights": [
        "08:00 출발 · 18:00 도착(예정), 빌바오↔마드리드 양방향 운행",
        "부루고스 대성당 관람 (유네스코 세계문화유산, 엘 시드의 무덤)",
        "산타 마리아 문 · 부루고스 성 전망대 자유시간",
        "한국어 · 영어 · 스페인어 가능 기사 사전 요청 가능",
        "최소 인원 미달 시 예약금 100% 환불"
      ],
      "includes": [
        "전용 차량",
  ...
  },
  {
    ...
    "detail": {
      ...
      "highlights": [
        "08:00 리스본 출발 · 18:00 마드리드 도착(예정)",
        "메리다 고고학 유적군 자유관광 (유네스코 세계문화유산)",
        "로마 극장 · 원형 경기장 · 다이아나 사원 · 로마 다리",
        "통합권으로 주요 명소 한번에 관람 가능",
        "최소 인원 미달 시 예약금 100% 환불"
      ],
      "includes": [
        "전용 차량",
  ...
  },
  {
    ...
    "detail": {
      ...
      "highlights": [
        "09:00 마드리드 출발 · 19:00 바르셀로나 도착(예정)",
        "필라르 성모 대성당 (고야 프레스코화, 전망 타워)",
        "라 세오 대성당 (유네스코 세계문화유산)",
        "알하페리아 궁전 · 로마 유적지",
        "최소 인원 미달 시 예약금 100% 환불"
      ],
      "includes": [
  ...
  },
  {
    ...
    "detail": {
      ...
      "highlights": [
        "08:00 바르셀로나 출발 · 18:00 마드리드 도착(예정)",
        "필라르 대성당 관광",
        "사라고사 자유시간 및 간단한 현지식 체험",
        "최소 인원 미달 시 예약금 100% 환불"
      ],
      "includes": [
        "전용 차량",
  ...
  },
  {
    ...
    "detail": {
      ...
      "highlights": [
        "08:00 포루투 출발 · 18:00 마드리드 도착(예정)",
        "살라망카 자유관광 (유네스코 세계문화유산)",
        "마요르 광장 · 살라망카 대학교 · 신·구 대성당",
        "구시가지 도보 관광으로 편리하게 이동",
        "최소 인원 미달 시 예약금 100% 환불"
      ],
      "includes": [
        "전용 차량",
  ...
  },
  {
    ...
    "detail": {
      ...
      "highlights": [
        "09:00 마드리드 출발 · 18:00 포루투 도착(예정)",
        "살라망카 2시간 자유관광 (유네스코 세계문화유산)",
        "마요르 광장 · 살라망카 대학교 · 신·구 대성당",
        "넉넉한 수납공간의 프라이빗 차량, VIP 의전 별도문의 가능",
        "최소 인원 미달 시 예약금 100% 환불"
      ],
      "includes": [
        "전용 차량",
  ...
  },
  {
    ...
    "detail": {
      ...
      "highlights": [
        "08:00 리스본 출발 · 18:00 세비야 도착(예정)",
        "베나길 동굴 전망 포인트 관람",
        "알가르브 해안 마을 자유시간 & 포토타임",
        "4인 미만은 프라이빗 투어로도 진행 가능",
        "최소 인원 미달 시 예약금 100% 환불"
      ],
      "includes": [
        "전용 차량",
  ...
  },
  {
    ...
    "detail": {
      ...
      "highlights": [
        "07:00 그라나다 출발 · 18:00 세비야 도착(예정)",
        "네르하 유럽의 발코니 자유관광 1시간",
        "프리힐리아나 하얀 마을 골목 자유관광 1시간",
        "론다 누에보 다리 · 투우장 자유관광 2시간",
        "4인 미만은 프라이빗 투어로도 진행 가능"
      ],
      "includes": [
        "전용 차량",
  ...
  },
  {
    ...
    "detail": {
      ...
      "highlights": [
        "08:00 세비야 출발 · 19:00 마드리드 도착(예정)",
        "꼬르도바 메스키타 대성당 관람 (유네스코 세계유산)",
        "유대인 지구 · 로마 다리 · 꽃길 거리",
        "최소 인원 미달 시 예약금 100% 환불"
      ],
      "includes": [
  ...
  },
  {
    ...
    "detail": {
      ...
      "highlights": [
        "09:00 마드리드 출발 · 18:00 세비야 도착(예정)",
        "콘수에그라 풍차 (돈키호테 배경, 일부 내부 관람 가능)",
        "콘수에그라 성 · 스페인 광장",
        "2시간 자유관광",
        "최소 인원 미달 시 예약금 100% 환불"
      ],
  ...
  },
  {
    ...
    "detail": {
      ...
      "highlights": [
        "제로니무스 수도원 · 벨렘탑 (세계유산)",
        "신트라 페나 궁전 · 유라시아 최서단 까보 다 로카",
        "오비두스 · 나자레 · 알코바사 · 바탈랴 세계유산 벨트",
        "파티마 성지 순례",
        "포르투 역사지구 · 동 루이스 1세 다리 · 포트와인 셀러",
        "브라가 · 기마랑이스 (포르투갈 건국의 도시)"
      ],
      "includes": [
        "파티마 호텔 석식 포함",
        "전용 차량 및 기사(현지 8일)",
      ...
      "excludes": [
        ...
        "선택 관광 비용",
        "가이드 · 기사 팁",
        "중식·석식 전체 자유식(파티마 호텔 석식 제외)",
        "포르투갈 도시별 숙박세(1인 1박 €2~4, 현지 납부)",
        "초과 수하물 요금"
      ],
  ...
  },
  {
    ...
    "detail": {
      ...
      "highlights": [
        "제로니무스 수도원 · 벨렘탑 (세계유산)",
        "신트라 문화경관 · 유라시아 최서단 까보 다 로카",
        "에보라 역사지구 (세계유산) · 뼈 예배당",
        "세비야 대성당 · 레알 알카사르 (세계유산)",
        "카르모나·론다 파라도르(국영 고성 호텔) 3박",
        "프리힐리아나 백색마을 · 알함브라 궁전 (세계유산)",
        "그라나다 알바이신 · 사크로몬테 · 프라도 미술관"
      ],
      "includes": [
        "전용 차량 및 기사(현지 12일 · 전 구간)",
        "한국인 인솔 가이드 전 일정 동행",
        "일정표 명시 도시 현지 가이드"
      ],
      "excludes": [
        ...
        "가이드 · 기사 팁",
        "개인 경비",
        "포르투갈 도시별 숙박세(리스본 1인 1박 €4, 현지 납부)",
        "초과 수하물 요금"
      ],
  ...
  },
  {
    ...
    "detail": {
      ...
      "highlights": [
        "사그라다 파밀리아 · 구엘 공원 (세계유산)",
        "몬세라트 수도원 · 발렌시아 라 론하 (세계유산)",
        "알함브라 궁전 (세계유산) · 프리힐리아나 백색마을",
        "론다·카르모나 파라도르(국영 고성 호텔) 3박",
        "세비야 대성당 · 레알 알카사르 (세계유산)",
        "코르도바 역사지구 (세계유산)",
        "프라도 미술관 · 파세오 델 프라도 (세계유산)",
        "사라고사 필라르 대성당 · 알하페리아 궁전 (세계유산)"
      ],
      "includes": [
        "전용 차량 및 기사(현지 12일 · 전 구간)",
        "한국인 인솔 가이드 전 일정 동행",
  ...
  },
  {
    ...
    "detail": {
      ...
      "highlights": [
        "부르고스 대성당 (세계유산)",
        "산티야나 델 마르와 알타미라 박물관 (세계유산)",
        "코미야스 · 가우디의 엘 카프리초",
        "산토냐 안초비 · 라레도 · 카스트로 우르디알레스",
        "비스카야 다리 곤돌라 (세계유산)",
        "구겐하임 빌바오 입장",
        "게타리아 · 사라우스 · 산세바스티안 라 콘차"
      ],
      "includes": [
        "전용 차량 및 기사 (현지 6일 · 전 구간)",
        "한국인 인솔 가이드 전 일정 동행"
      ],
      "excludes": [
        "왕복 국제선 항공권 — 마드리드 현지 집합 상품입니다",
        "4성급 호텔 5박 · 조식 포함 (산탄데르 3 · 빌바오 2)",
        "일정표 명시 입장료 — 부르고스 대성당 · 알타미라 박물관 · 구겐하임 빌바오 · 비스카야 다리 곤돌라",
        "여행자 보험",
        "마드리드 전후 숙박 (집합 전날 숙박은 별도 안내)",
        "중식 · 석식 (자유식 기준 · 유료 식사 구성 가능)",
        "선택 관광 비용",
        "가이드 · 기사 팁 · 개인 경비",
        "바스크 관광숙박세 — 2027년 1월 1일부터 빌바오에 신설, 출발 시점 확정 금액으로 별도 청구",
        "초과 수하물 요금"
      ],
  ...
  },
  {
    ...
    "detail": {
      ...
      "highlights": [
        "레온 대성당과 산티아고 순례길 (세계유산)",
        "코바동가 성지 · 산타 쿠에바",
        "피코스 데 에우로파 · 푸엔테 데 케이블카 (해발 1,823m)",
        "라 에르미다 협곡과 포테스 · 산토 토리비오 수도원",
        "오비에도 선로마네스크 산타 마리아 델 나랑코 (세계유산)",
        "산티야나 델 마르와 알타미라 박물관 (세계유산)",
        "리바데세야 · 야네스 · 코미야스 해안"
      ],
      "includes": [
      ...
      "excludes": [
        "왕복 국제선 항공권 — 마드리드 현지 집합 상품입니다",
        "4성급 호텔 5박 · 조식 포함 (오비에도 2 · 산탄데르 3)",
        "일정표 명시 입장료 — 레온 대성당 · 산타 마리아 델 나랑코 · 산토 토리비오 수도원 · 푸엔테 데 케이블카 · 알타미라 박물관",
        "여행자 보험",
        "마드리드 전후 숙박 (집합 전날 숙박은 별도 안내)",
        "중식 · 석식 (자유식 기준 · 유료 식사 구성 가능)",
        "코바동가 호수 선택 관광 — 6/1~10/18 셔틀버스 환승 구간, 별도 문의",
        "그 밖의 선택 관광 비용",
        "가이드 · 기사 팁 · 개인 경비",
        "초과 수하물 요금"
      ],
  ...
  },
  {
    ...
    "detail": {
      ...
      "highlights": [
        "프라도 미술관 · 마드리드 왕궁",
        "필라르 성모 대성당 · 알하페리아 궁전 (사라고사)",
        "사그라다 파밀리아 · 구엘 공원 (가우디의 하루)",
        "예술과학도시 (발렌시아) · 알함브라 궁전 (그라나다)",
        "세비야 대성당 · 알카사르 · 스페인 광장",
        "파티마 성지 순례 · 코임브라 대학",
        "포르투 역사지구 · 포트와인 셀러",
        "벨렝 지구 · 호카곶 (유라시아 대륙 서쪽 끝)"
      ],
      "includes": [
        "전 일정 전용 차량(공항 픽업~샌딩)",
        "한국인 인솔자 전 일정 동행"
      ...
      "excludes": [
        "국제선 항공권(마드리드 IN·리스본 OUT 오픈조 별도 안내)",
        "호텔 13박 · 2인 1실 기준 · 조식 13회",
        "일정에 명시된 입장료 전부",
        "여행자 보험",
        "조식 외 전 일정 식사(중식 · 석식 모두 자유식)",
        "개인 경비 · 기념품",
        "선택 관광(플라멩코, 포트와인 셀러 추가 시음 등)",
        "가이드 · 기사 팁",
        "싱글차지(1인 1실 이용 시)"
      ],
  ...
  },
  {
    ...
    "detail": {
      ...
      "highlights": [
        "리스본 IN · 마드리드 OUT — 되돌아가는 구간 없음",
        "산티아고 데 콤포스텔라와 땅끝 피니스테레",
        "피코스 데 에우로파 코바동가 호수",
        "가우디의 엘 카프리초와 알타미라 복제 동굴",
        "산 세바스티안 2박 — 하루는 온전히 쉬어 갑니다"
      ],
      "includes": [
        "4성급 호텔 15박 (2인 1실)",
        "45인승 전용차량 (공항 픽업·샌딩 포함)",
        "한국어 가이드 전 일정 동행",
        "조식 15회 · 중식 13회 · 석식 6회",
        "일정표에 표기된 입장료 전부",
        "코바동가 호수 택시"
