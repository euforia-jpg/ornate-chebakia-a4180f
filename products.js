...
const PRODUCTS = [
  {
    ...
    detail: {
      lead: '09:00 마드리드 아토차역 출발, 톨레도에서 약 4시간 관광 후 17:00경 마드리드로 돌아오는 프리미엄 당일 차량투어예요.',
      description: '마드리드 아토차 기차역에서 09:00 출발해, 유네스코 세계문화유산 도시 톨레도에서 약 4시간 동안 톨레도 대성당 관람, 산토토메(엘 그레코 명작 감상), 톨레도 골목 자유시간을 즐긴 뒤 17:00경 마드리드 아토차 기차역으로 돌아오는 일정이에요. 중식은 자유시간 중 각자 해결하시면 돼요(불포함). 한국인 기사가 전 일정 동행하며, 인원에 따라 프라이빗 밴(4-6인), 스프린터 차량(7-15인), 전용 버스(15-30인) 중 배정돼요. 확정일 기준 예약 인원이 4인 미만이면 예약금을 100% 환불해 드려요. 확정 안내는 일정 시작 2주 전까지 문자로 연락드리며, 미팅 장소는 미정이라 확정 후 개별 공지해 드리니 예약 시 숙박하시는 호텔 주소를 함께 알려주세요.',
  ...
  },
  {
    ...
    days: '5박 7일',
    price: '1인 285만원',
    title: '[포르투갈 완전일주] 리스본 2박 + 포르투 3박 5박 7일',
    summary: '낭만과 감성이 공존하는 포르투갈, 리스본 2박과 포르투 3박으로 완전일주하는 5박 7일 패키지예요. 전 일정 4성급 호텔, 전용차량과 전문 가이드가 함께해요.',
    tags: ['5박 7일', '전 일정 가이드 동행', '4성급 호텔'],
    detail: {
      lead: '인천에서 출발해 리스본 2박, 포르투 3박으로 포르투갈을 완전일주하는 5박 7일 코스예요. 전 일정 4성급 호텔과 전용차량, 전문 가이드가 함께해요.',
      description: 'DAY1 인천 국제공항 출발(KE921) 후 리스본 도착, 픽업 차량으로 호텔 이동. DAY2 리스본 시내 가이드 투어 — 아우구스타 개선문 거리, 알파마 지구 도보 투어, 포르타스 두 솔 전망대, 리스본 대성당. DAY3 신트라 페나 궁전, 호카곶(유라시아 대륙 서쪽 끝), 카스카이스를 거쳐 포르투로 이동. DAY4 오전 자유시간 후 포르투 시내 관광 & 야경투어 — 클레리고스 성당과 타워, 렐루서점, 카르무 성당, 상벤투 기차역, 동 루이스 1세 다리, 하베이라 항구. DAY5 포르투 자유일정(상벤투 기차역 앞 산타 카타리나 쇼핑거리, 하베이라 광장). DAY6 오전 자유시간 후 포르투역에서 열차로 리스본 이동(약 3시간~3시간 30분 소요), 리스본역 도착 후 픽업 차량으로 공항 이동, 저녁 리스본 출발(KE922). DAY7 인천 국제공항 도착(19:15). 전 일정 체류 기간 동안 한국어 가능한 현지 매니저가 실시간으로 도와드리는 Trip Concierge Service도 제공돼요.',
      highlights: ['리스본 2박 + 포르투 3박, 완전일주 5박 7일', '전 일정 4성급 호텔 · 전용차량 · 전문 가이드 동행', '신트라 페나 궁전 · 호카곶 · 카스카이스 경유', '포르투 야경투어 (동 루이스 다리 · 하베이라 항구)', '한국어 가능 현지 매니저 실시간 Trip Concierge Service'],
      includes: ['전 일정 숙박 (4성급 호텔)', '전용차량 및 전용 가이드', '일정상 명시된 식사', '일정상 명시된 관광지 입장료', '가이드 & 기사 경비', 'Trip Concierge Service (한국어 가능 현지 매니저 실시간 도움)'],
      excludes: ['국제선 항공', '유류할증료', '개인경비', '매너팁', '여행자보험'],
      duration: '5박 7일 (2026년 출발, 최소 4인 기준 · 일정은 항공 및 현지 사정에 따라 변경될 수 있어요)'
    }
  },
  {
    id: 'spain-round',
  ...
  },
  {
    ...
    tags: ['프라이빗 차량', '한국인 기사 동행'],
    detail: {
      lead: '08:00 리스본 출발, 알가르브 해안의 보석 베나길에서 동굴 전망과 자유시간(포토타임)을 즐긴 뒤 18:00경 세비야에 도착하는 프리미엄 당일 차량투어예요.',
      description: '리스본 호텔 또는 지정 장소에서 08:00 출발해, 세계에서 가장 아름다운 해식 동굴로 꼽히는 베나길 동굴(Algar de Benagil)이 있는 알가르브 해안 마을 베나길에서 동굴 전망 포인트 관람과 자유시간(포토타임)을 즐긴 뒤 18:00경 스페인 세비야에 도착하는 일정이에요. 베나길 동굴은 육로로 연결되지 않아 보트나 카약으로만 들어갈 수 있고, 천장 구멍으로 쏟아지는 햇살이 장관을 이뤄요. 중식은 자유시간 중 각자 해결하시면 돼요(불포함). 한국인 기사가 전 일정 동행하며, 인원에 따라 프라이빗 밴(4-6인), 스프린터 차량(7-15인), 전용 버스(15-30인) 중 배정돼요. 4인 미만은 상담 후 프라이빗 투어로도 진행 가능해요. 확정일 기준 예약 인원이 4인 미만이면 예약금을 100% 환불해 드려요. 확정 안내는 일정 시작 2주 전까지 문자로 연락드리며, 미팅 장소는 미정이라 확정 후 개별 공지해 드리니 예약 시 숙박하시는 호텔 주소를 함께 알려주세요.',
  ...
  },
  {
    ...
    tags: ['프라이빗 차량', '한국인 기사 동행'],
    detail: {
      lead: '08:00 세비야 출발, 알가르브 해안의 보석 베나길에서 동굴 보트 투어 & 자유시간을 즐긴 뒤 18:00경 리스본에 도착하는 프리미엄 당일 차량투어예요.',
      description: '세비야 호텔 또는 지정 장소에서 08:00 출발해, 세계에서 가장 아름다운 해식 동굴로 꼽히는 베나길 동굴(Algar de Benagil)이 있는 알가르브 해안 마을 베나길에서 동굴 보트 투어와 자유시간(포토타임)을 즐긴 뒤 18:00경 리스본에 도착하는 일정이에요. 베나길 동굴은 육로로 연결되지 않아 보트나 카약으로만 들어갈 수 있고, 천장 구멍으로 쏟아지는 햇살이 장관을 이뤄요. 중식은 자유시간 중 각자 해결하시면 돼요(불포함). 한국인 기사가 전 일정 동행하며, 인원에 따라 프라이빗 밴(4-6인), 스프린터 차량(7-15인), 전용 버스(15-30인) 중 배정돼요. 4인 미만은 상담 후 프라이빗 투어로도 진행 가능해요. 확정일 기준 예약 인원이 4인 미만이면 예약금을 100% 환불해 드려요. 확정 안내는 일정 시작 2주 전까지 문자로 연락드리며, 미팅 장소는 미정이라 확정 후 개별 공지해 드리니 예약 시 숙박하시는 호텔 주소를 함께 알려주세요.',
