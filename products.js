...
const PRODUCTS = [
  ...
  { name: '4부 — 상상력의 끝판왕, 세속적 쾌락의 동산', url: '/audio/prado-4-jardin.mp3', bg: '/audio/bg-boccherini-minuet.mp3' , lat: 40.4138, lng: -3.6921, yt: '-CHyk7gAli8' },
  { name: '5부 — 스페인 최대의 미술 스캔들, 마하 두 점', url: '/audio/prado-5-maja.mp3', bg: '/audio/bg-boccherini-minuet.mp3' , lat: 40.4138, lng: -3.6921, yt: '8CmyGenw7tQ' },
  ...
  tags: ['5박 6일', '자유일정 가능'],
    audioGuide: [
      { name: '사그라다 파밀리아 1부 — 144년의 역사', url: '/audio/sagrada-familia-1.mp3', bg: '/audio/bg-sagrada-organ-choir.mp3', lat: 41.4036, lng: 2.1744, yt: 'gbeFkf4ppqM' },
      { name: '사그라다 파밀리아 2부 — 세 개의 파사드', url: '/audio/sagrada-familia-2.mp3', bg: '/audio/bg-sagrada-organ-choir.mp3', lat: 41.4036, lng: 2.1744, yt: 'gbeFkf4ppqM' },
