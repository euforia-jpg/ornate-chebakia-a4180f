...
const PRODUCTS = [
  ...
  },
  {
    ...
    detail: {
     ...
     description: '<strong>DAY1</strong> 인천 국제공항 출발(KE921) 후 리스본 도착, 픽업 차량으로 호텔 이동.<br><br><strong>DAY2</strong> 리스본 시내 가이드 투어 — 아우구스타 개선문 거리, 알파마 지구 도보 투어, 포르타스 두 솔 전망대, 리스본 대성당.<br><br><strong>DAY3</strong> 신트라 페나 궁전, 호카곶(유라시아 대륙 서쪽 끝), 카스카이스를 거쳐 포르투로 이동.<br><br><strong>DAY4</strong> 오전 자유시간 후 포르투 시내 관광 & 야경투어 — 클레리고스 성당과 타워, 렐루 서점, 카르무 성당, 상벤투 기차역, 동 루이스 1세 다리, 하베이라 항구.<br><br><strong>DAY5</strong> 포르투 자유일정(상벤투 기차역 앞 산타 카타리나 쇼핑거리, 하베이라 광장).<br><br><strong>DAY6</strong> 오전 자유시간 후 포르투역에서 열차로 리스본 이동(약 3시간~3시간 30분 소요), 리스본역 도착 후 픽업 차량으로 공항 이동, 저녁 리스본 출발(KE922).<br><br><strong>DAY7</strong> 인천 국제공항 도착(19:15).',
