...
<p class="i-foot">
  ...
  {
    id: 'portugal-north-spain-17days',
    cats: ['spain', 'portugal'],
    topClass: 'iberia',
    region: 'SPAIN · PORTUGAL',
    days: '15박 17일',
    price: '가격 문의',
    title: '포르투갈 · 북스페인 리스본 IN · 마드리드 OUT 15박 17일',
    summary: '리스본으로 들어가 포르투갈을 북으로 거슬러 오르고, 산티아고에서 스페인 북부 해안을 동쪽으로 건너, 바스크와 카스티야를 지나 마드리드에서 나오는 일정이에요. 같은 길을 두 번 밟지 않습니다.',
    tags: ['15박 17일', '포르투갈 · 북스페인', '대한항공 직항', '한붓그리기'],
    isNew: true,
    detail: {
      lead: '리스본 2박 · 포르투 2박 · 산티아고 2박 · 히혼 1박 · 코미야스 1박 · 빌바오 1박 · 산 세바스티안 2박 · 부르고스 1박 · 세고비아 1박 · 마드리드 2박. 포르투갈과 스페인 북부를 한 획으로 잇는 15박 17일이에요.',
      description: `<style>

@import url('https://fonts.googleapis.com/css2?family=IBM+Plex+Mono:wght@400;500;600&family=IBM+Plex+Sans+KR:wght@300;400;500;600;700&display=swap');

/* 중립색은 다른 일정표(.eu-iberia15 등)와 같은 값을 씁니다. 라이트 전용. */
.eu-ib17{
  --ink:#20292B;
  --paper:#FAF7F1;
  --tile:#EFEDE5;
...
.eu-ib17 *{box-sizing:border-box}
.eu-ib17 .i-wrap{max-width:940px; margin:0 auto; padding:40px 22px 80px}
.eu-ib17 h1,.eu-ib17 h2,.eu-ib17 h3{margin:0; font-weight:600; line-height:1.3; letter-spacing:-.015em; color:var(--ink)}
.eu-ib17 p{margin:0}
.eu-ib17 .i-mono{font-family:"IBM Plex Mono",monospace; font-variant-numeric:tabular-nums}

.eu-ib17 .i-hero{border-bottom:2px solid var(--ink); padding-bottom:22px}
.eu-ib17 .i-kick{font-size:11.5px; font-weight:600; letter-spacing:.18em; color:var(--sp); text-transform:uppercase}
.eu-ib17 .i-hero h1{font-size:clamp(28px,5.2vw,44px); margin-top:12px}
.eu-ib17 .i-sub{margin-top:14px; color:var(--muted); font-size:16px; max-width:62ch}
.eu-ib17 .i-facts{display:flex; flex-wrap:wrap; margin-top:20px; border:1px solid var(--line);
  background:var(--card); box-shadow:var(--shadow)}
.eu-ib17 .i-fact{flex:1 1 140px; padding:12px 16px; border-right:1px solid var(--hair)}
.eu-ib17 .i-fact:last-child{border-right:0}
.eu-ib17 .i-fact .k{font-size:11px; font-weight:600; letter-spacing:.07em; color:var(--faint)}
.eu-ib17 .i-fact .v{margin-top:3px; font-size:15px; font-weight:600}

.eu-ib17 .i-sec{margin-top:46px}
.eu-ib17 .i-shead{display:flex; align-items:baseline; gap:12px; flex-wrap:wrap;
  border-bottom:1px solid var(--ink); padding-bottom:8px}
.eu-ib17 .i-shead h2{font-size:20px}
.eu-ib17 .i-shead .t{font-size:11.5px; color:var(--muted); font-family:"IBM Plex Mono",monospace}
.eu-ib17 .i-lead{margin-top:14px; color:var(--muted); max-width:68ch; font-size:15px}
.eu-ib17 .i-lead b{color:var(--ink); font-weight:600}

.eu-ib17 .i-scroll{overflow-x:auto; margin-top:16px; border:1px solid var(--line); background:var(--card); box-shadow:var(--shadow)}
.eu-ib17 table{width:100%; border-collapse:collapse; font-size:14px}
.eu-ib17 th,.eu-ib17 td{padding:9px 13px; text-align:left; border-bottom:1px solid var(--hair); vertical-align:middle; color:var(--muted)}
.eu-ib17 thead th{font-size:11px; font-weight:600; letter-spacing:.08em; color:var(--muted);
  text-transform:uppercase; background:var(--tile); border-bottom:1px solid var(--line); white-space:nowrap}
.eu-ib17 tbody tr:last-child td{border-bottom:0}
.eu-ib17 td.n,.eu-ib17 th.n{text-align:right; white-space:nowrap; font-family:"IBM Plex Mono",monospace; font-variant-numeric:tabular-nums}
.eu-ib17 tr.hi td{background:var(--sp-soft); color:var(--ink); font-weight:500}
.eu-ib17 td b{color:var(--ink); font-weight:600}

.eu-ib17 .i-note{margin-top:14px; padding:15px 18px; background:var(--och-soft);
  border-left:3px solid var(--och); font-size:14.5px; line-height:1.65; color:var(--muted)}
.eu-ib17 .i-note.sp{background:var(--sp-soft); border-left-color:var(--sp)}
.eu-ib17 .i-note.pt{background:var(--pt-soft); border-left-color:var(--pt)}
.eu-ib17 .i-note b{color:var(--ink); font-weight:600}
.eu-ib17 .i-note + .i-note{margin-top:10px}

.eu-ib17 .i-days{margin-top:22px}
.eu-ib17 .i-day{display:grid; grid-template-columns:104px 1fr; gap:0 20px; position:relative; padding-bottom:26px}
.eu-ib17 .i-rail{position:relative; padding-top:2px}
.eu-ib17 .i-rail::before{content:""; position:absolute; left:17px; top:38px; bottom:-26px; width:1px; background:var(--line)}
.eu-ib17 .i-day:last-child .i-rail::before{display:none}
.eu-ib17 .i-num{width:36px; height:36px; border-radius:50%; display:flex; align-items:center; justify-content:center;
  background:var(--sp); color:#fff; font-family:"IBM Plex Mono",monospace; font-size:14px; font-weight:600;
  position:relative; z-index:2}
.eu-ib17 .i-day.pt .i-num{background:var(--pt)}
.eu-ib17 .i-when{margin-top:8px; font-size:12px; font-weight:600; color:var(--muted); letter-spacing:.02em; line-height:1.4}
.eu-ib17 .i-body{padding-top:4px}
.eu-ib17 .i-city{font-size:17.5px; font-weight:600; letter-spacing:-.01em; color:var(--ink)}
.eu-ib17 .i-move{margin-top:3px; font-size:12.5px; color:var(--faint); font-family:"IBM Plex Mono",monospace}
.eu-ib17 .i-body ul{margin:10px 0 0; padding:0; list-style:none; display:flex; flex-direction:column; gap:6px}
.eu-ib17 .i-body li{font-size:14.5px; color:var(--muted); line-height:1.6; padding-left:14px; position:relative}
.eu-ib17 .i-body li::before{content:""; position:absolute; left:0; top:9px; width:5px; height:5px;
  background:var(--och); border-radius:50%}
.eu-ib17 .i-day.pt .i-body li::before{background:var(--pt)}
.eu-ib17 .i-body li b{color:var(--ink); font-weight:500}
.eu-ib17 .i-meal{margin-top:10px; font-size:12px; color:var(--faint); font-family:"IBM Plex Mono",monospace; letter-spacing:.03em}
.eu-ib17 .i-stay{display:inline-block; margin-top:8px; padding:2px 9px; font-size:11.5px; font-weight:600;
  background:var(--tile); color:var(--stone); letter-spacing:.02em}
@media (max-width:600px){
  .eu-ib17 .i-day{grid-template-columns:1fr; gap:8px}
  .eu-ib17 .i-rail{display:flex; align-items:center; gap:12px}
  .eu-ib17 .i-rail::before{display:none}
  .eu-ib17 .i-when{margin-top:0}
}

.eu-ib17 .i-band{margin:6px 0 30px; padding:16px 20px; background:var(--pt-soft);
  border-top:2px solid var(--pt); border-bottom:1px solid var(--line);
  display:flex; align-items:center; gap:16px; flex-wrap:wrap}
.eu-ib17 .i-band svg{flex:0 0 auto; color:var(--pt)}
.eu-ib17 .i-band .bt{font-size:14.5px; line-height:1.6; color:var(--muted)}
.eu-ib17 .i-band .bt b{color:var(--ink); font-weight:600}
.eu-ib17 .i-band.back{background:var(--sp-soft); border-top-color:var(--sp)}
.eu-ib17 .i-band.back svg{color:var(--sp)}

.eu-ib17 .i-incl{display:grid; grid-template-columns:1fr 1fr; gap:14px; margin-top:16px}
.eu-ib17 .i-box{background:var(--card); border:1px solid var(--line); padding:16px 18px 17px; box-shadow:var(--shadow)}
.eu-ib17 .i-box h3{font-size:14.5px; letter-spacing:.02em}
.eu-ib17 .i-box.in h3{color:var(--sp)}
.eu-ib17 .i-box.out h3{color:var(--och)}
.eu-ib17 .i-box ul{margin:10px 0 0; padding:0; list-style:none; display:flex; flex-direction:column; gap:6px}
.eu-ib17 .i-box li{font-size:14px; color:var(--muted); line-height:1.55; padding-left:15px; position:relative}
.eu-ib17 .i-box.in li::before{content:"+"; position:absolute; left:0; top:0; color:var(--sp); font-weight:600}
.eu-ib17 .i-box.out li::before{content:"−"; position:absolute; left:0; top:0; color:var(--och); font-weight:600}
.eu-ib17 .i-box li b{color:var(--ink); font-weight:500}
@media (max-width:600px){ .eu-ib17 .i-incl{grid-template-columns:1fr} }

.eu-ib17 .i-foot{margin-top:46px; padding-top:18px; border-top:1px solid var(--line);
  font-size:12px; color:var(--faint); line-height:1.7}
.eu-ib17 .i-foot b{color:var(--muted); font-weight:500}
...
<div class="i-hero">
  <p class="i-kick">Euforia Tour Spain · 포르투갈 · 북스페인 한붓그리기</p>
  <h1>리스본에서 마드리드까지, 되돌아가지 않는 15박 17일</h1>
  <p class="i-sub">리스본으로 들어가 포르투갈을 북으로 거슬러 올라가고, 산티아고에서 스페인 북부 해안을 동쪽으로 건너, 바스크와 카스티야를 지나 마드리드에서 나옵니다. 같은 길을 두 번 밟지 않는 한붓그리기 노선입니다.</p>
  <div class="i-facts">
    <div class="i-fact"><p class="k">기간</p><p class="v">15박 17일</p></div>
    <div class="i-fact"><p class="k">출입국</p><p class="v">리스본 IN · 마드리드 OUT</p></div>
    <div class="i-fact"><p class="k">방문 국가</p><p class="v">포르투갈 · 스페인</p></div>
    <div class="i-fact"><p class="k">이동</p><p class="v">45인승 전용차량</p></div>
    <div class="i-fact"><p class="k">가이드</p><p class="v">한국어 · 전 일정 동행</p></div>
  </div>
</div>
...
<div class="i-sec">
  <div class="i-shead">
    <h2>이 일정이 지나는 곳</h2>
    <span class="t">10개 도시 · 되돌아가는 구간 없음</span>
  </div>
  <p class="i-lead"><b>포르투갈</b>(리스본·신트라·코임브라·아베이루·포르투)에서 시작해 국경을 넘어 <b>갈리시아</b>(산티아고·피니스테레·묵시아), <b>아스투리아스와 칸타브리아</b>(쿠디예로·히혼·코바동가·피코스 데 에우로파·코미야스), <b>바스크</b>(빌바오·가스텔루가체·산 세바스티안), <b>라 리오하와 카스티야</b>(와이너리·부르고스·세고비아·톨레도)를 지나 마드리드에서 끝납니다.</p>
  <p class="i-lead" style="margin-top:12px">흔한 이베리아 패키지가 리스본과 마드리드를 왕복하는 데 비해, 이 일정은 <b>반도의 북쪽 해안선을 통째로 따라갑니다.</b> 스페인 사람들이 "초록 스페인"이라 부르는 지역인데, 한국 단체 일정에는 거의 들어가지 않는 구간입니다.</p>
</div>

<div class="i-sec">
  <div class="i-shead">
    <h2>항공 — 대한항공 직항, 들어가는 곳과 나오는 곳이 다릅니다</h2>
    <span class="t">국제선은 불포함입니다</span>
  </div>
  <p class="i-lead">리스본으로 들어가 마드리드로 나오기 때문에 <b>같은 길을 되짚어 오지 않습니다.</b> 왕복 일정이라면 마지막 이틀을 이동에 써야 하는데, 그 시간을 그대로 관광에 씁니다.</p>

  <div class="i-scroll">
    <table>
      <thead>
        <tr><th>구간</th><th>편명</th><th>시각</th><th>비고</th></tr>
      </thead>
      <tbody>
        <tr class="hi"><td><b>인천 → 리스본</b></td><td class="i-mono">KE921</td><td class="i-mono">12:25 → 20:20</td><td>1일차 · 직항</td></tr>
        <tr class="hi"><td><b>마드리드 → 인천</b></td><td class="i-mono">KE914</td><td class="i-mono">20:00 출발</td><td>16일차 · 기내박</td></tr>
      </tbody>
    </table>
  </div>

  <div class="i-note sp">
    <b>운항 시각은 시기에 따라 바뀝니다.</b> 출발일이 정해지면 그 날짜의 스케줄과 좌석 현황을 확인해 안내드립니다.
    항공권은 상품에 포함되지 않으며, 다른 항공사로 오시는 경우에도 도착 시각에 맞춰 픽업합니다.
  </div>
</div>
...
<div class="i-sec">
  <div class="i-shead">
    <h2>일정</h2>
    <span class="t">1일 ~ 17일</span>
  </div>

  <div class="i-days">

    <div class="i-day pt">
      <div class="i-rail"><div class="i-num">1</div><div class="i-when">리스본<br>도착</div></div>
      <div class="i-body">
        <p class="i-city">인천 → 리스본</p>
        <p class="i-move">KE921 · 12:25 인천 출발 → 20:20 리스본 도착</p>
        <ul>
          <li><b>대한항공 직항</b>으로 리스본까지 한 번에 들어갑니다</li>
          <li>도착 후 전용 차량으로 호텔 이동, 첫날은 쉬어 갑니다</li>
        </ul>
        <p class="i-meal">식사 — 기내식 / 석식 불포함</p><br><span class="i-stay">리스본 1박</span>
      </div>
    </div>

    <div class="i-day pt">
      <div class="i-rail"><div class="i-num">2</div><div class="i-when">리스본<br>신트라</div></div>
      <div class="i-body">
        <p class="i-city">리스본 → 신트라 → 리스본</p>
        <p class="i-move">약 60km · 왕복</p>
        <ul>
          <li><b>신트라 역사지구</b> — 대서양 바람이 닿는 언덕 위 왕실 피서지</li>
          <li><b>제로니무스 수도원</b>과 <b>벨렝탑</b> — 대항해시대가 시작된 자리</li>
          <li><b>아우구스타 거리</b>와 코메르시우 광장, <b>알파마</b> 골목</li>
          <li><b>포르타스 두 솔 전망대</b> — 붉은 지붕과 테주 강이 한눈에</li>
        </ul>
        <p class="i-meal">식사 — 조식 · 중식(현지식) / 석식 불포함</p><br><span class="i-stay">리스본 1박</span>
      </div>
    </div>

    <div class="i-day pt">
      <div class="i-rail"><div class="i-num">3</div><div class="i-when">포르투</div></div>
      <div class="i-body">
        <p class="i-city">리스본 → 코임브라 → 코스타노바 → 아베이루 → 포르투</p>
        <p class="i-move">약 320km · 북상</p>
        <ul>
          <li><b>코임브라</b> — 구 대성당 외부, <b>산타크루스 수도원</b> 본당 입장</li>
          <li><b>코스타노바</b> — 줄무늬로 칠한 어부의 집들이 늘어선 해변 마을</li>
          <li><b>아베이루</b> — 운하를 따라 몰리세이루 배가 오가는 "포르투갈의 베네치아"</li>
        </ul>
        <p class="i-meal">식사 — 조식 · 중식(현지식) · 석식(현지식)</p><br><span class="i-stay">포르투 1박</span>
      </div>
    </div>

    <div class="i-day pt">
      <div class="i-rail"><div class="i-num">4</div><div class="i-when">포르투</div></div>
      <div class="i-body">
        <p class="i-city">포르투</p>
        <p class="i-move">시내 도보 · 도우루 강 유람</p>
        <ul>
          <li><b>볼량 시장</b>과 <b>렐루 서점</b> 내부 — 나무 계단이 붉게 휘어 오르는 그 서점</li>
          <li><b>상 벤투 역</b> 아줄레주 벽화, <b>클레리구스 탑</b>, <b>카르무 성당</b></li>
          <li><b>히베이라 광장</b> — 강가에 색색으로 붙어 선 옛 집들</li>
          <li><b>도우루 크루즈</b> — 여섯 개 다리 아래를 지나는 유람선</li>
        </ul>
        <p class="i-meal">식사 — 조식 · 중식 자유식 · 석식(한식)</p><br><span class="i-stay">포르투 1박</span>
      </div>
    </div>
    ...
    <div class="i-band back">
      ...
      <p class="bt"><b>여기서 국경을 넘습니다.</b> 포르투에서 미뉴 강을 건너면 갈리시아입니다.
      같은 이베리아 반도지만 언어도 음식도 바뀌고, 여기서부터는 순례길의 땅입니다.</p>
    </div>
  <div class="i-days">

    <div class="i-day">
      <div class="i-rail"><div class="i-num">5</div><div class="i-when">산티아고</div></div>
      <div class="i-body">
        <p class="i-city">포르투 → 산티아고 데 콤포스텔라</p>
        <p class="i-move">약 230km · 국경을 넘어 갈리시아로</p>
        <ul>
          <li><b>산티아고 대성당</b> — 순례길 900km가 끝나는 곳</li>
          <li><b>오브라도이로 광장</b> — 순례자들이 배낭을 내려놓고 주저앉는 자리</li>
          <li><b>킨타나 광장</b>과 <b>프라테리아스 광장</b>, 구시가 골목</li>
        </ul>
        <p class="i-meal">식사 — 조식 · 중식(현지식) / 석식 자유식</p><br><span class="i-stay">산티아고 1박</span>
      </div>
    </div>

    <div class="i-day">
      <div class="i-rail"><div class="i-num">6</div><div class="i-when">산티아고<br>땅끝</div></div>
      <div class="i-body">
        <p class="i-city">산티아고 → 묵시아 → 피니스테레 → 산티아고</p>
        <p class="i-move">약 200km · 왕복</p>
        <ul>
          <li><b>에자로 폭포</b> — 바다로 곧장 떨어지는 유럽에서 드문 폭포</li>
          <li><b>피니스테레 곶</b> — 로마인들이 땅의 끝이라 부른 0km 표지석</li>
          <li><b>묵시아</b> — 바위 위 성당 하나와 대서양뿐인 마을</li>
        </ul>
        <p class="i-meal">식사 — 조식 · 중식(현지식) / 석식 자유식</p><br><span class="i-stay">산티아고 1박</span>
      </div>
    </div>
    ...
    <div class="i-day">
      <div class="i-rail"><div class="i-num">7</div><div class="i-when">히혼</div></div>
      <div class="i-body">
        <p class="i-city">산티아고 → 쿠디예로 → 히혼</p>
        <p class="i-move">약 330km · 북부 해안선</p>
        <ul>
          <li><b>아스 카테드라이스 해변</b> — 썰물 때만 드러나는 바위 아치들</li>
          <li><b>카보 비디오 절벽</b>과 <b>쿠디예로</b> — 비탈에 계단처럼 붙은 어촌</li>
          <li><b>히혼 시마데비야</b> — 옛 어부 마을 언덕과 항구</li>
        </ul>
        <p class="i-meal">식사 — 조식 · 중식(현지식) · 석식(현지식)</p><br><span class="i-stay">히혼 1박</span>
      </div>
    </div>

    <div class="i-day">
      <div class="i-rail"><div class="i-num">8</div><div class="i-when">코미야스</div></div>
      <div class="i-body">
        <p class="i-city">히혼 → 코바동가 → 피코스 데 에우로파 → 코미야스</p>
        <p class="i-move">약 250km · 산으로</p>
        <ul>
          <li><b>코바동가 성지</b> — 레콘키스타가 시작된 바위 동굴 성당</li>
          <li><b>피코스 데 에우로파 코바동가 호수</b> — 8인승 택시로 산정 호수까지 오릅니다</li>
          <li>초록 산과 소 떼, 스페인 같지 않은 스페인</li>
        </ul>
        <p class="i-meal">식사 — 조식 · 중식(현지식) · 석식(현지식)</p><br><span class="i-stay">코미야스 1박</span>
      </div>
    </div>

    <div class="i-day">
      <div class="i-rail"><div class="i-num">9</div><div class="i-when">빌바오</div></div>
      <div class="i-body">
        <p class="i-city">코미야스 → 빌바오</p>
        <p class="i-move">약 170km · 칸타브리아 해안</p>
        <ul>
          <li><b>엘 카프리초</b> — 가우디가 청년 시절에 지은 별장, 정원과 외관</li>
          <li><b>엘 소플라오 동굴</b> 내부 — 기묘하게 휘어 자란 석순이 가득한 동굴</li>
          <li><b>알타미라 국립박물관</b> 내부 — 구석기 벽화를 정밀 복제한 네오쿠에바</li>
        </ul>
        <p class="i-meal">식사 — 조식 · 중식(현지식) / 석식 자유식</p><br><span class="i-stay">빌바오 1박</span>
      </div>
    </div>

    <div class="i-day">
      <div class="i-rail"><div class="i-num">10</div><div class="i-when">산 세바스티안</div></div>
      <div class="i-body">
        <p class="i-city">빌바오 → 가스텔루가체 → 산 세바스티안</p>
        <p class="i-move">약 130km · 바스크 해안</p>
        <ul>
          <li><b>빌바오 미술관</b> 내부와 <b>구겐하임</b> 외관, 구시가 <b>7개의 골목</b></li>
          <li><b>산 후안 데 가스텔루가체</b> — 바다 위 바위섬으로 이어지는 241개의 계단</li>
        </ul>
        <p class="i-meal">식사 — 조식 · 중식(아시안뷔페) · 석식(현지식)</p><br><span class="i-stay">산 세바스티안 1박</span>
      </div>
    </div>

    <div class="i-day">
      <div class="i-rail"><div class="i-num">11</div><div class="i-when">산 세바스티안</div></div>
      <div class="i-body">
        <p class="i-city">산 세바스티안</p>
        <p class="i-move">시내 도보 · 여유 있는 하루</p>
        <ul>
          <li><b>라 콘차 해변</b> — 도시를 껴안듯 둥글게 휜 만</li>
          <li><b>미라마르 궁전</b>, <b>헌법광장</b>, <b>산 비센테 교회</b></li>
          <li>구시가지 핀초스 거리 — 바스크 미식의 본고장</li>
        </ul>
        <p class="i-meal">식사 — 조식 / 중식 · 석식 자유식</p><br><span class="i-stay">산 세바스티안 1박</span>
      </div>
    </div>

    <div class="i-day">
      <div class="i-rail"><div class="i-num">12</div><div class="i-when">부르고스</div></div>
      <div class="i-body">
        <p class="i-city">산 세바스티안 → 라 리오하 → 부르고스</p>
        <p class="i-move">약 290km · 와인 산지</p>
        <ul>
          <li><b>리오하 와이너리</b> — 포도밭과 오크통 저장고를 둘러보고 <b>와인 테이스팅</b></li>
          <li><b>유소 수도원</b> 내부 — 스페인어가 처음 글로 적힌 곳</li>
        </ul>
        <p class="i-meal">식사 — 조식 · 중식(현지식) / 석식 자유식</p><br><span class="i-stay">부르고스 1박</span>
      </div>
    </div>

    <div class="i-day">
      <div class="i-rail"><div class="i-num">13</div><div class="i-when">세고비아</div></div>
      <div class="i-body">
        <p class="i-city">부르고스 → 세고비아</p>
        <p class="i-move">약 200km · 카스티야 고원</p>
        <ul>
          <li><b>부르고스 대성당</b> — 스페인 고딕의 정점, <b>산타 마리아 개선문</b></li>
          <li><b>세고비아 수도교</b> — 2,000년 동안 회반죽 없이 서 있는 로마 수도교</li>
          <li>세고비아 구시가지</li>
        </ul>
        <p class="i-meal">식사 — 조식 · 중식(현지식) / 석식 자유식</p><br><span class="i-stay">세고비아 1박</span>
      </div>
    </div>

    <div class="i-day">
      <div class="i-rail"><div class="i-num">14</div><div class="i-when">마드리드</div></div>
      <div class="i-body">
        <p class="i-city">세고비아 → 라스 로사스 → 마드리드</p>
        <p class="i-move">약 100km</p>
        <ul>
          <li><b>세고비아 알카사르</b> 내부 — 백설공주 성의 모델로 불리는 성</li>
          <li><b>코치니요 특식</b> — 세고비아의 새끼돼지 통구이</li>
          <li><b>라스 로사스 빌리지</b> 쇼핑</li>
        </ul>
        <p class="i-meal">식사 — 조식 · 중식(코치니요 특식) · 석식(한식)</p><br><span class="i-stay">마드리드 1박</span>
      </div>
    </div>

    <div class="i-day">
      <div class="i-rail"><div class="i-num">15</div><div class="i-when">마드리드<br>톨레도</div></div>
      <div class="i-body">
        <p class="i-city">마드리드 → 톨레도 → 마드리드</p>
        <p class="i-move">약 140km · 왕복</p>
        <ul>
          <li><b>톨레도 대성당</b> 내부와 <b>알카사르</b>, 엘 그레코가 걷던 구시가지</li>
          <li><b>산토 토메</b> 내부 — 「오르가스 백작의 매장」 한 점을 위해 서는 곳</li>
          <li><b>파라도르 특식</b> — 톨레도 전경이 내려다보이는 파라도르에서 3코스</li>
        </ul>
        <p class="i-meal">식사 — 조식 · 중식(파라도르 특식) / 석식 자유식</p><br><span class="i-stay">마드리드 1박</span>
      </div>
    </div>

    <div class="i-day">
      <div class="i-rail"><div class="i-num">16</div><div class="i-when">마드리드<br>출발</div></div>
      <div class="i-body">
        <p class="i-city">마드리드 → 공항</p>
        <p class="i-move">KE914 · 20:00 마드리드 출발</p>
        <ul>
          <li><b>프라도 미술관</b> 내부 — 벨라스케스와 고야를 마지막으로</li>
          <li><b>마요르 광장</b>과 <b>스페인 광장</b></li>
          <li>저녁 공항 이동, <b>대한항공 직항</b>으로 귀국</li>
        </ul>
        <p class="i-meal">식사 — 조식 · 중식(현지식) · 석식(기내식)</p><br><span class="i-stay">기내박</span>
      </div>
    </div>

    <div class="i-day">
      <div class="i-rail"><div class="i-num">17</div><div class="i-when">인천<br>도착</div></div>
      <div class="i-body">
        <p class="i-city">인천 도착</p>
        <p class="i-move">도착 후 해산</p>
        <ul>
          <li>인천국제공항 도착, 수하물을 찾고 해산합니다</li>
        </ul>
        <p class="i-meal">식사 — 기내식</p>
      </div>
    </div>
...
<div class="i-sec">
  <div class="i-shead">
    <h2>숙박</h2>
    <span class="t">전 일정 4성급 · 2인 1실</span>
  </div>
  <p class="i-lead">같은 도시에 <b>이틀씩 묵는 곳이 다섯 군데</b>입니다. 매일 짐을 싸고 푸는 일정이 아니라, 거점을 두고 주변을 도는 구간이 섞여 있습니다.</p>

  <div class="i-scroll">
    <table>
      <thead>
        <tr><th>도시</th><th class="n">숙박</th><th>성격</th></tr>
      </thead>
      <tbody>
        <tr class="hi"><td><b>리스본</b></td><td class="n">2박</td><td>신트라 왕복을 여유 있게</td></tr>
        <tr class="hi"><td><b>포르투</b></td><td class="n">2박</td><td>시내 도보와 도우루 강</td></tr>
        <tr class="hi"><td><b>산티아고 데 콤포스텔라</b></td><td class="n">2박</td><td>땅끝 피니스테레 왕복</td></tr>
        <tr><td>히혼</td><td class="n">1박</td><td>아스투리아스 해안</td></tr>
        <tr><td>코미야스</td><td class="n">1박</td><td>가우디의 엘 카프리초</td></tr>
        <tr><td>빌바오</td><td class="n">1박</td><td>구겐하임과 구시가</td></tr>
        <tr class="hi"><td><b>산 세바스티안</b></td><td class="n">2박</td><td>하루는 온전히 쉬어 갑니다</td></tr>
        <tr><td>부르고스</td><td class="n">1박</td><td>대성당과 순례길</td></tr>
        <tr><td>세고비아</td><td class="n">1박</td><td>수도교 야경</td></tr>
        <tr class="hi"><td><b>마드리드</b></td><td class="n">2박</td><td>톨레도 왕복과 프라도</td></tr>
      </tbody>
    </table>
  </div>
  <div class="i-note">예정 호텔은 <b>현지 사정에 따라 동급 호텔로 변경</b>될 수 있습니다. 확정 호텔은 출발 전 안내드립니다.</div>
</div>

<div class="i-sec">
  <div class="i-shead">
    <h2>식사</h2>
    <span class="t">조식 15회 · 중식 13회 · 석식 6회</span>
  </div>
  <p class="i-lead">전 일정 <b>호텔 조식</b>이 포함되고, 그 밖에 <b>중식 13회와 석식 6회</b>가 들어갑니다. 나머지는 자유식이라 드시고 싶은 곳에서 각자 해결하시면 됩니다.</p>
  <p class="i-lead" style="margin-top:12px">포함된 식사 중에는 <b>한식 2회</b>, <b>아시안뷔페 1회</b>가 있어 중간에 입이 쉬어 갑니다. 특식으로는 <b>세고비아 코치니요</b>(새끼돼지 통구이)와 <b>톨레도 파라도르 3코스</b>가 들어 있습니다.</p>
</div>
...
<div class="i-sec">
  ...
  <div class="i-incl">
    <div class="i-box in">
      <h3>포함됩니다</h3>
      <ul>
        <li><b>4성급 호텔 15박</b> · 2인 1실 기준</li>
        <li><b>45인승 전용차량</b> — 공항 픽업·샌딩 포함</li>
        <li><b>한국어 가이드</b> 전 일정 동행 · 주요 관광지 현지 로컬가이드</li>
        <li><b>조식 15회 · 중식 13회 · 석식 6회</b></li>
        <li>일정표에 표기된 <b>입장료 전부</b> — 코임브라 산타크루스 수도원, 렐루 서점, 도우루 크루즈, 엘 카프리초, 엘 소플라오 동굴, 알타미라 국립박물관, 빌바오 미술관, 리오하 와이너리 투어 + 테이스팅, 유소 수도원, 부르고스 대성당, 세고비아 알카사르, 톨레도 대성당, 산토 토메, 프라도 미술관</li>
        <li><b>코바동가 호수 택시</b> (8인승, 산정 구간)</li>
      </ul>
    </div>
    <div class="i-box out">
      <h3>포함되지 않습니다</h3>
      <ul>
        <li><b>국제선 항공권</b> — 별도 안내드립니다</li>
        <li><b>자유식 식사</b> — 포함 표기 외 전부</li>
        <li><b>선택 관광</b> — 파두 공연, 플라멩코 등</li>
        <li><b>수신기</b> (무선 안내 수신기)</li>
        <li>개인 경비, 음료, 기념품</li>
        <li>가이드·기사 팁</li>
        <li><b>싱글 차지</b> — 1인 1실 이용 시 별도</li>
      </ul>
    </div>
  </div>
  <div class="i-note pt"><b>단체 기준 상품입니다.</b> 인원과 출발 시기에 따라 요금이 달라지므로 <b>문의 주시면 견적을 내 드립니다.</b> 일정도 인원·기간에 맞춰 조정해 드립니다.</div>
</div>

<p class="i-foot">
  <b>Euforia Tour Spain</b> · EUFORIA DAS NUVENS S.L. · 마드리드 · CICMA 4443<br>
  이동 거리는 실제 도로 기준 근사치입니다 · 항공 스케줄은 항공사 사정에 따라 변경될 수 있습니다 · 알타미라는 원본 동굴이 아닌 정밀 복제 동굴(네오쿠에바)을 관람합니다 · 렐루 서점, 프라도 미술관 등 지정 시각 입장 시설은 예약 상황에 따라 방문 순서가 조정될 수 있습니다 · 피코스 데 에우로파 코바동가 호수는 기상과 현지 통제에 따라 운행이 제한될 수 있습니다
</p>

</div>
</div>`,
      highlights: ['리스본 IN · 마드리드 OUT — 되돌아가는 구간 없음', '산티아고 데 콤포스텔라와 땅끝 피니스테레', '피코스 데 에우로파 코바동가 호수', '가우디의 엘 카프리초와 알타미라 복제 동굴', '산 세바스티안 2박 — 하루는 온전히 쉬어 갑니다', '세고비아 코치니요 · 톨레도 파라도르 특식'],
      includes: ['4성급 호텔 15박 (2인 1실)', '45인승 전용차량 (공항 픽업·샌딩 포함)', '한국어 가이드 전 일정 동행', '조식 15회 · 중식 13회 · 석식 6회', '일정표에 표기된 입장료 전부', '코바동가 호수 택시'],
      excludes: ['국제선 항공권', '자유식 식사', '선택 관광', '수신기', '개인 경비', '가이드·기사 팁', '싱글 차지'],
      duration: '15박 17일 (리스본 IN · 마드리드 OUT)'
    }
  },
];
