...
const PRODUCTS = [
  ...
  },
  {
    ...
    price: '가격 문의',
    audioGuide: [
  { name: '1부 — 그림 속의 그림, 시녀들', url: bg: '/audio/bg-prado-piano.mp3', bg: bg: '/audio/bg-prado-piano.mp3' , lat: 40.4138, lng: -3.6921, yt: '3tUN9rq2MyU' },
  { name: '2부 — 전쟁의 참혹함, 1808년 5월 3일', url: bg: '/audio/bg-prado-piano.mp3', bg: bg: '/audio/bg-prado-piano.mp3' , lat: 40.4138, lng: -3.6921, yt: 'JfLrdnL1pHM' },
  { name: '3부 — 고야의 어두운 걸작, 아들을 삼키는 사투르누스', url: bg: '/audio/bg-prado-piano.mp3', bg: bg: '/audio/bg-prado-piano.mp3' , lat: 40.4138, lng: -3.6921, yt: 'xD7dXIzPVrc' },
  { name: '4부 — 상상력의 끝판왕, 세속적 쾌락의 동산', url: bg: '/audio/bg-prado-piano.mp3', bg: bg: '/audio/bg-prado-piano.mp3' , lat: 40.4138, lng: -3.6921, yt: '-CHyk7gAli8' },
  { name: '5부 — 스페인 최대의 미술 스캔들, 마하 두 점', url: bg: '/audio/bg-prado-piano.mp3', bg: bg: '/audio/bg-prado-piano.mp3' , lat: 40.4138, lng: -3.6921, yt: '8CmyGenw7tQ' },
  { name: '6부 — 엘 그레코, 가슴에 손을 얹은 기사', url: bg: '/audio/bg-prado-piano.mp3', bg: bg: '/audio/bg-prado-piano.mp3' , lat: 40.4138, lng: -3.6921, yt: '7cKbY4_mQXk' },
  { name: '7부 — 눈물의 명작, 십자가에서 내려지는 그리스도', url: bg: '/audio/bg-prado-piano.mp3', bg: bg: '/audio/bg-prado-piano.mp3' , lat: 40.4138, lng: -3.6921, yt: 'KdQRjgvqxwg' },
  { name: '8부 — 왕실을 향한 우아한 조롱, 카를로스 4세의 가족', url: bg: '/audio/bg-prado-piano.mp3', bg: bg: '/audio/bg-prado-piano.mp3' , lat: 40.4138, lng: -3.6921, yt: 'eC3-4vrZP_k' },
  { name: '9부 — 독일 르네상스의 자존심, 아담과 이브', url: bg: '/audio/bg-prado-piano.mp3', bg: bg: '/audio/bg-prado-piano.mp3' , lat: 40.4138, lng: -3.6921, yt: '' },
],
  ...
  tags: ['5박 6일', '자유일정 가능'],
    audioGuide: [
      { name: '사그라다 파밀리아 1부 — 144년의 역사', url: '/audio/sagrada-familia-1.mp3', bg: '/audio/bg-sagrada-organ-choir.mp3', lat: 41.4036, lng: 2.1744, yt: 'VCM3tho_PFQ' },
      { name: '사그라다 파밀리아 2부 — 세 개의 파사드', url: '/audio/sagrada-familia-2.mp3', bg: '/audio/bg-sagrada-organ-choir.mp3', lat: 41.4036, lng: 2.1744, yt: 'KqMD2RBqUxA' },
