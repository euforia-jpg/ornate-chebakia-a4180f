...
const PRODUCTS = [
  ...
  id: 'camino-100',
    ...
    detail: {
      ...
      description: '<div style="display:flex; gap:10px; margin-bottom:14px; font-size:12px;""><strong style="flex:0 0 auto;">DAY1</strong><span>투이(Tui) → 오 포리뇨(O Porriño) 약 16km 도보.</span></div><div style="display:flex; gap:10px; margin-bottom:14px;"><strong style="flex:0 0 auto;">DAY2</strong><span>오 포리뇨 → 레돈델라(Redondela) 약 16km 도보.</span></div><div style="display:flex; gap:10px; margin-bottom:14px;"><strong style="flex:0 0 auto;">DAY3</strong><span>레돈델라 → 폰테베드라(Pontevedra) 약 21km 도보.</span></div><div style="display:flex; gap:10px; margin-bottom:14px;"><strong style="flex:0 0 auto;">DAY4</strong><span>폰테베드라 → 칼다스 데 레이스(Caldas de Reis) 약 22km 도보.</span></div><div style="display:flex; gap:10px; margin-bottom:14px;"><strong style="flex:0 0 auto;">DAY5</strong><span>칼다스 데 레이스 → 파드론(Padrón) 약 19km 도보.</span></div><div style="display:flex; gap:10px;"><strong style="flex:0 0 auto;">DAY6</strong><span>파드론 → 산티아고 데 콤포스텔라 대성당 약 25km 도보로 완주.</span></div>',
