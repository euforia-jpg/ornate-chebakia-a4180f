...
const PRODUCTS = [
  ...
  tags: ['5박 6일', '자유일정 가능'],
    audioGuide: [
      { name: '사그라다 파밀리아 1부 — 144년의 역사', url: '/audio/sagrada-familia-1.mp3', bg: '/audio/bg-ballade-no1.mp3', lat: 41.4036, lng: 2.1744, yt: 'gbeFkf4ppqM' },
      { name: '사그라다 파밀리아 2부 — 세 개의 파사드', url: '/audio/sagrada-familia-2.mp3', bg: '/audio/bg-ballade-no1.mp3', lat: 41.4036, lng: 2.1744, yt: 'gbeFkf4ppqM' },
