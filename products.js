...
const PRODUCTS = [
  {
    ...
    audioGuide: [
      { name: '톨레도 대성당', url: '/audio/madrid-toledo-sample.mp3' },
      { name: '산토토메', url: '/audio/toledo-santotome.mp3' },
    ],
  ...
  },
  {
    ...
    price: '가격 문의',
    audioGuide: [
  { name: '1부 — 그림 속의 그림, 시녀들', url: '/audio/prado-1-meninas.mp3', bg: '/audio/bg-boccherini-minuet.mp3' },
  { name: '2부 — 전쟁의 참혹함, 1808년 5월 3일', url: '/audio/prado-2-tresmayo.mp3', bg: '/audio/bg-boccherini-minuet.mp3' },
  { name: '3부 — 고야의 어두운 걸작, 아들을 삼키는 사투르누스', url: '/audio/prado-3-saturno.mp3', bg: '/audio/bg-boccherini-minuet.mp3' },
  { name: '4부 — 상상력의 끝판왕, 세속적 쾌락의 동산', url: '/audio/prado-4-jardin.mp3', bg: '/audio/bg-boccherini-minuet.mp3' },
  { name: '5부 — 스페인 최대의 미술 스캔들, 마하 두 점', url: '/audio/prado-5-maja.mp3', bg: '/audio/bg-boccherini-minuet.mp3' },
  { name: '6부 — 엘 그레코, 가슴에 손을 얹은 기사', url: '/audio/prado-6-caballero.mp3', bg: '/audio/bg-boccherini-minuet.mp3' },
  { name: '7부 — 눈물의 명작, 십자가에서 내려지는 그리스도', url: '/audio/prado-7-descendimiento.mp3', bg: '/audio/bg-boccherini-minuet.mp3' },
  { name: '8부 — 왕실을 향한 우아한 조롱, 카를로스 4세의 가족', url: '/audio/prado-8-familia.mp3', bg: '/audio/bg-boccherini-minuet.mp3' },
  { name: '9부 — 독일 르네상스의 자존심, 아담과 이브', url: '/audio/prado-9-adaneva.mp3', bg: '/audio/bg-boccherini-minuet.mp3' },
],
