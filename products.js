...
const PRODUCTS = [
  {
    ...
    "detail": {
      ...
      "description": "09:00 마드리드 아토차 기차역 출발, 유네스코 세계문화유산 도시 톨레도에서 약 4시간 동안 톨레도 대성당 관람, 산토 토메(엘 그레코 명작 감상), 톨레도 골목 자유시간을 즐겨요.  <br><br>17:00경 마드리드 아토차 기차역 도착으로 일정이 마무리돼요. 중식은 자유시간 중 각자 해결하시면 돼요 (불포함). 한국인 기사가 전 일정 동행하며, 인원에 따라 프라이빗 밴(4~6인), 스프린터 차량(7~15인), 전용 버스(15~30인) 중 배정돼요. 확정일 기준 예약 인원이 4인 미만이면 예약금을 100% 환불해 드려요. 확정 안내는 일정 시작 2주 전까지 문자로 연락드리며, 미팅 장소는 미정이라 확정 후 개별 공지해 드리니 예약 시 숙박하시는 호텔 주소를 함께 알려주세요.",
      "highlights": [
  ...
  },
  {
    ...
    "detail": {
      ...
      "description": "리스본 기차역 또는 지정 장소에서 08:00 출발해, 고대 로마 제국 루시타니아 주의 수도였던 메리다에서 로마 극장, 로마 원형 경기장, 다이아나 사원, 로마 다리 등 유네스코 세계문화유산 '메리다 고고학 유적군'을 자유관광한 뒤 <br><br>18:00경 마드리드에 도착하는 일정이에요. 메리다는 대부분의 명소를 통합권 하나로 관람할 수 있어 편리해요. 한국인 기사가 전 일정 동행하며, 인원에 따라 프라이빗 밴(4-6인), 스프린터 차량(7-15인), 전용 버스(15-30인) 중 배정돼요. 확정일 기준 예약 인원이 4인 미만이면 예약금을 100% 환불해 드려요. 확정 안내는 일정 시작 2주 전까지 문자로 연락드리며, 미팅 장소는 미정이라 확정 후 개별 공지해 드리니 예약 시 숙박하시는 호텔 주소를 함께 알려주세요.",
      "highlights": [
  ...
  },
  {
    ...
    "detail": {
      "lead": "08:00 리스본 출발, 알가르브 해안의 보석 베나길에서 동굴 전망과 자유시간(포토타임)을 즐긴 뒤 <br>\n18:00경 세비야에 도착하는 프리미엄 당일 차량 투어예요.",
      "description": "08:00 리스본 호텔 또는 지정 장소 출발, 세계에서 가장 아름다운 해식 동굴로 꼽히는 베나길 동굴(Algar de Benagil)이 있는 알가르브 해안 마을 베나길에서 동굴 전망 포인트 관람과 자유시간(포토타임)을 즐겨요. 베나길 동굴은 육로로 연결되지 않아 보트나 카약으로만 들어갈 수 있고, 천장 구멍으로 쏟아지는 햇살이 장관을 이뤄요. \n<br><br>\n18:00경 스페인 세비야 도착으로 일정이 마무리돼요. 중식은 자유시간 중 각자 해결하시면 돼요 (불포함). 한국인 기사가 전 일정 동행하며, 인원에 따라 프라이빗 밴(4~6인), 스프린터 차량(7~15인), 전용 버스(15~30인) 중 배정돼요. 4인 미만은 상담 후 프라이빗 투어로도 진행 가능해요. 확정일 기준 예약 인원이 4인 미만이면 예약금을 100% 환불해 드려요. 확정 안내는 일정 시작 2주 전까지 문자로 연락드리며, 미팅 장소는 미정이라 확정 후 개별 공지해 드리니 예약 시 숙박하시는 호텔 주소를 함께 알려주세요.",
      "highlights": [
  ...
  },
  {
    ...
    "detail": {
      "lead": "08:00 세비야 출발, 알가르브 해안의 보석 베나길에서 동굴 보트 투어 & 자유시간을 즐긴 뒤<br><br>18:00경 리스본에 도착하는 프리미엄 당일 차량 투어예요.",
      "description": "08:00 세비야 호텔 또는 지정 장소 출발, 세계에서 가장 아름다운 해식 동굴로 꼽히는 베나길 동굴(Algar de Benagil)이 있는 알가르브 해안 마을 베나길에서 동굴 보트 투어와 자유시간(포토타임)을 즐겨요. 베나길 동굴은 육로로 연결되지 않아 보트나 카약으로만 들어갈 수 있고, 천장 구멍으로 쏟아지는 햇살이 장관을 이뤄요. <br><br>18:00경 리스본 도착으로 일정이 마무리돼요. 중식은 자유시간 중 각자 해결하시면 돼요 (불포함). 한국인 기사가 전 일정 동행하며, 인원에 따라 프라이빗 밴(4~6인), 스프린터 차량(7~15인), 전용 버스(15~30인) 중 배정돼요. 4인 미만은 상담 후 프라이빗 투어로도 진행 가능해요. 확정일 기준 예약 인원이 4인 미만이면 예약금을 100% 환불해 드려요. 확정 안내는 일정 시작 2주 전까지 문자로 연락드리며, 미팅 장소는 미정이라 확정 후 개별 공지해 드리니 예약 시 숙박하시는 호텔 주소를 함께 알려주세요.",
      "highlights": [
